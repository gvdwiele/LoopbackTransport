...
namespace LoopbackTransport.Installation
{
    public static class LoopbackTransportInstaller
    {
        ...
        const string _v2framework32MachineConfig = @"C:\Windows\Microsoft.NET\Framework64\v2.0.50727\CONFIG\machine.config";
        const string _v2framework64MachineConfig = @"C:\Windows\Microsoft.NET\Framework\v2.0.50727\CONFIG\machine.config";
        ...
        {
            if (File.Exists(_v2framework32MachineConfig))
                Install(_v2framework32MachineConfig);
            if (File.Exists(_v2framework64MachineConfig))
                Install(_v2framework64MachineConfig);
        }
        ...
        {
            if (File.Exists(_v2framework32MachineConfig))
                Uninstall(_v2framework32MachineConfig);
            if (File.Exists(_v2framework64MachineConfig))
                Uninstall(_v2framework64MachineConfig);
        }
